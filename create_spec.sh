...
RELEASE_FILE="RELEASE_${SCALA_VERSION}_${RPM_VERSION}_${RPM_RELEASE_POSTFIX}"
...
cat $1 | sed "s@##RPMVERSION##@${RPM_VERSION}@g; s@##RPMRELEASE##@${RPM_RELEASE_ID}@g; s@##SCALAVERSION##@${SCALA_VERSION}@g" > $2
